/*
 * CmdShellEnvironmentalValueProvider.java
 * 
 ...
 * @since 16.08.2006
 */
public class CommandShellEnvironmentalValueProvider implements IEnvironmentalValueProvider {
	...
	public Properties getEnviromentalValues() {
		try {
			...
			commandBuffer.append("command.com");
